    ...
    <div className='container mx-auto p-10'>
      ...
      <div className='flex justify-between'>
        <div className='w-2/4'>
          ...
          <p className='text-xl font-light mt-2'>Gg. Kresna No.8, Canggu, Kec. Kuta Utara, Kabupaten Badung, Bali 80361</p>
          <p className='text-xl font-light mt-1'>4-6 tamu . Seluruh rumah . 4 tempat tidur . 3 kamar mandi Wifi . Dapur . Parkir gratis</p>
        ...
        <div className='flex justify-end h-max'>
          <div className="h-auto p-5 bg-white shadow-xl">
            <div className='flex'>
              <h4 className='font-bold flex  max-w-full'>Rp. 4.000.000 / malam</h4>
            </div>
